...
namespace CoreIdentity.API.Identity.Controllers
{
    ...
    public class UserRolesController : Controller
    {
        ...
        /// <returns></returns>
        /// 
        [Authorize(Constants.Claims.ManageUsersRoles)]
        [HttpPost]
        ...
        public async Task<IActionResult> Delete(string Id, string RoleId)
        {
            ...
            if (Id == Constants.DefaultUser.Id && RoleId == Constants.DefaultRole.Id)
                return BadRequest(new string[] { "Can't delete predefined roles!" });
