        ...
        public static void ConfigureService(IServiceCollection service, string Issuer, string Audience, string Key)
        {
            service
                ...
                .AddJwtBearer(o =>
                {
                    ...
                    o.SaveToken = true;
                    o.TokenValidationParameters = BuildTokenValidationParameters(Issuer, Audience, Key);
                });
        }

        public static TokenValidationParameters BuildTokenValidationParameters(string Issuer, string Audience, string Key)
        {
