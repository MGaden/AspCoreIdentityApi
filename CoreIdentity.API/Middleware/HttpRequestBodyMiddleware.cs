...
namespace CoreIdentity.API.Middleware
{
    ...
    public static class HttpRequestBodyMiddlewareExtensions
    {
        public static IApplicationBuilder UseHttpRequestBodyMiddleware(this IApplicationBuilder builder)
        {
            return builder.UseMiddleware<HttpRequestBodyMiddleware>();
        }
    }
}